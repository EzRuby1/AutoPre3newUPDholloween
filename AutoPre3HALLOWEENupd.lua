...
getgenv().webhook = "getgenv().webhook = "https://discord.com/api/webhooks/1308808878011453440/qxHre1hKYENlVyYR9va22SpBli8a7j16lkyhEGTQQqwyKHOoqNR11YmZs31vkZsRcaAk" --change this if u want to use ur own webhook
" --change this if u want to use ur own webhook
